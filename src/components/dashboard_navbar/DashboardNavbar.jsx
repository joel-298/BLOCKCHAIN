      ...
      {navVisible && (
        <div className={styles.nav_div}>
          ...
          <div className={styles.child2}>
            ...
            <div className={styles.content_items}>
              <Link href="/dashboard/wallet" passHref onClick={handleLinkClick} className={styles.links}>
                Wallet
              </Link>
            </div>
            <div className={styles.content_items}>
            ...
            <div className={styles.content_items}>
              <Link href="/dashboard/settings" passHref onClick={handleLinkClick} className={styles.links}>
                Settings
              </Link>
            </div>
            <div className={styles.content_items}>
              <Link href="/dashboard/accounts" passHref onClick={handleLinkClick} className={styles.links}>
                Accounts
              </Link>
            </div>
          </div>
